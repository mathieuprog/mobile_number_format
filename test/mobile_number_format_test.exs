defmodule MobileNumberFormatTest do
  ...
  test "parse/1" do
    assert {:ok, %{iso_country_code: "BE", country_calling_code: "32", national_number: "455123456", trimmed_national_number_input: "455123456"}} =
      MobileNumberFormat.parse(%{iso_country_code: "BE", country_calling_code: "+32", national_number: "455123456"})
    assert {:ok, %{iso_country_code: "BE", country_calling_code: "32", national_number: "455123456", trimmed_national_number_input: "455123456"}} =
      MobileNumberFormat.parse(%{country_calling_code: "+32", national_number: "455123456"})
    assert {:ok, %{iso_country_code: "BE", country_calling_code: "32", national_number: "455123456", trimmed_national_number_input: "455123456"}} =
      MobileNumberFormat.parse(%{iso_country_code: "BE", national_number: "455123456"})

    assert {:ok, %{iso_country_code: "BE", country_calling_code: "32", national_number: "455123456", trimmed_national_number_input: "455123456"}} =
      MobileNumberFormat.parse(%{country_calling_code: "+32", national_number: "0455123456"})

    assert {:ok, %{iso_country_code: "BE", country_calling_code: "32", national_number: "455123456"}} =
      MobileNumberFormat.parse(%{iso_country_code: "BE", country_calling_code: 32, national_number: "455123456"})
    assert {:ok, %{iso_country_code: "BE", country_calling_code: "32", national_number: "455123456", trimmed_national_number_input: "455/12.34.56"}} =
      MobileNumberFormat.parse(%{iso_country_code: "BE", country_calling_code: 32, national_number: "455/12.34.56"})
    assert {:ok, %{iso_country_code: "BE", country_calling_code: "32", national_number: "455123456", trimmed_national_number_input: "455123456"}} =
      MobileNumberFormat.parse(%{iso_country_code: "BE", country_calling_code: 32, national_number: 455123456})

    assert {:ok, %{iso_country_code: "BE", country_calling_code: "32", national_number: "455123456"}} =
      MobileNumberFormat.parse(%{iso_country_code: "BE", international_number: "+32455123456"})
    assert {:ok, %{iso_country_code: "BE", country_calling_code: "32", national_number: "455123456"}} =
    ...
    assert {:ok, %{iso_country_code: "BE", country_calling_code: "32", national_number: "455123456", trimmed_national_number_input: "455/1   - 2.34.56"}} =
    ...
    assert {:ok, %{iso_country_code: "MP", country_calling_code: "1", national_number: "6702345678", trimmed_national_number_input: "67.02.34.56.78"}} =
    ...
    assert :invalid_country_calling_code == MobileNumberFormat.parse(%{iso_country_code: "BE", country_calling_code: "+33", national_number: "0455123456"})
    assert :invalid_country_calling_code == MobileNumberFormat.parse(%{iso_country_code: "FR", country_calling_code: "+32", national_number: "0455123456"})
  ...
  test "valid_iso_country_code?/1" do
    assert MobileNumberFormat.valid_iso_country_code?("BE")

    refute MobileNumberFormat.valid_iso_country_code?("be")
    refute MobileNumberFormat.valid_iso_country_code?(" BE")
  end
end
